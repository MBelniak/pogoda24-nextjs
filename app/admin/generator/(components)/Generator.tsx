...
import { useGenerator } from '@/app/admin/generator/hooks/useGenerator';
import { cityList, imgSrcsDay, imgSrcsNight } from '@/app/admin/generator/meta/consts';
...
export const Generator = () => {
    ...
    const [, setCookie] = useCookies<string, Record<string, string>>([]);

    function saveCookie(name: string, value: string) {
        setCookie(name, value, { expires: add(new Date(), { years: 1 }) });
    }
